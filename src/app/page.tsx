...
export default function Home() {
  ...
  const animals = ["Kucing", "Tikus", "Kadal", "Anomali", "Kuda Nil", "Bunglon", "Siput", "Koala", "Kodok", "Monyet", "Anjing", "Harimau", "Kuda", "Komodo", "Gajah", "Cicak", "Ular", "Anomali", "Kura-kura", "Lele", "Laba-laba", "Singa", "Zebra", "Bebek", "Ayam", "Buaya", "Gorila", "Naga", "Naga", "Ikan", "Ubu-ubur", "Cacing", "Semut", "Udang", "Musang", "Kecoak", "Kupu-kupu", "Laba-laba", "Biawak", "Kurama", "Anomali", "Tikus", "Raja", "Raja", "Jangkrik", "Lipan", "Ulat Bulu", "Kucing", "Panda", "Anomali", "Sepuh"];
  const behaviours = ["Jawa", "Depresi", "Mekanik", "Metal", "Insom", "Skizo", "Klepto", "Bunting", "Birahi", "Sigma", "Raksasa", "Berkaki Seribu", "Skizo", "Sad boy", "Kayang", "Mewing", "Gyatt", "Yapper", "Skizo", "Second Choice", "Ambis", "Sigma", "Dribble", "Jawa", "Kayang", "Ngesot", "Sunda", "Kalimantan", "Kutub", "Sumatera", "Sunda", "Sumatera", "Yapper", "Ngesot", "Ambis", "Kayang", "Pemarah", "Kocak", "Second Choice :)", "Push Up", "Gila", "Dark System", "Top Frag", "Bottom Frag", "Cupu", "Silver", "Emas", "Perak", "Cilacap", "Kocak"];

  const things = ["Speaker JBL", "Toa Masjid", "Lemari 2 Pintu", "Kulkas", "Taplak Meja", "Pecel Lele", "Charger Iphone", "Airpods", "Kalkulator", "Sendal Jepit", "Undur-undur Maju", "Bagas Dribble", "Sendal Jepit", "Sapu Lidi", "Gagang Pintu", "Tutup Toples", "Rice Cooker", "Gerobak Ketoprak", "Ban Motor", "Bakwan Jagung", "Rice Cooker", "Nugget Rebus", "Asep Kulkas", "Bintang Skibidi", "Helikopter", "Laba-laba Sunda", "Raja Beruang", "Nastar", "Seblak Ceker", "Macan Cisewu", "Zaki Indomie", "Farhan Kebab", "Rizal Perkedel", "Joko Kopling", "Reza Wangsaf", "Sigit Rendang", "Biawak Alaska", "Budi Martabak", "Nurdin Basket", "Edgar Burger", "Aspal Tol Cipularang", "Tuyul Mohawk", "Aldi Taher", "Cocomelon", "Maaf yang ini khodamnya kabur", "Orang Normal 😀", "Kereta Thomas"]
